...
?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			echo do_shortcode( '[social_share]' );
					...
					<span class="qbutton_holder"><a href="<?php the_permalink(); ?>" class="qbutton tiny"><?php esc_html_e('READ MORE','river'); ?></a></span>
				</div>
			</div>
		</article>
<?php
...
?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			echo do_shortcode( '[social_share]' );
						...
						<?php if(river_qode_is_comments_enabled()){ ?><a  class="post_comments" href="<?php comments_link(); ?>"><i class="icon-large icon-comments"></i> <span><?php comments_number( '0', '1', '%'); ?></a></span><?php } ?>
						<span class="post_social">
							<?php if( river_qode_is_like_enabled() ) { ?>
								<span class="blog_like">
									 <?php if(function_exists('qode_like')) { qode_like(); } ?>
